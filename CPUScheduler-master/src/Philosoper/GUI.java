...
//        chartPanel.setPreferredSize(new Dimension(700, 10));
        ...
        option = new JComboBox(new String[]{"FCFS", "SJF", "SRT", "PNP", "PP", "RR"});
        option.setBounds(390, 420, 85, 20);
        
        computeBtn2=new JButton("Main Menu");
        computeBtn2.setForeground(Color.BLUE);
        computeBtn2.setBounds(25,480,120,25);
        computeBtn2.setFont(new Font("Segoe UI", Font.PLAIN, 15));
        computeBtn2.addActionListener(new ActionListener(){
        	
        	public void actionPerformed(ActionEvent e) {
        		frame.dispose();
    			oss us = new oss();
    			us.setTitle("CPU SCHEDULER");
    			us.setVisible(true);
        	}
        });
        
        computeBtn = new JButton("Compute");
        computeBtn.setBounds(390, 450, 100, 25);
        computeBtn.setForeground(Color.BLUE);
        computeBtn.setFont(new Font("Segoe UI", Font.PLAIN, 15));
        ...
        mainPanel.add(computeBtn2);
        mainPanel.setBackground(new Color(1, 33, 63));
        ...
        frame.add(mainPanel);
        frame.pack();
        frame.setBounds(500, 100, 520, 550);
    }
